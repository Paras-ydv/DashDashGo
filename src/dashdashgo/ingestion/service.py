...
from dashdashgo.errors import SchemaDriftError
...
class IngestionService:
    ...
    def validate(self, frame: pd.DataFrame, report: ReportConfig) -> PreparedDataset:
        ...
        rejected = frame.iloc[outcome.rejected_positions].copy()
        rejected["_errors"] = ["; ".join(outcome.row_errors[p]) for p in outcome.rejected_positions]
